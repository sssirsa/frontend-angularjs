(function () {
    ...
    /* @ngInject */
    function routesController(Routes, Helper, $scope, toastr, Translate, $mdDialog) {
        ...
        function update() {
            Routes.update(vm.route).then(function (res) {
        ...
        function create() {
            Routes.create(vm.route).then(function (res) {
