(function () {
    ...
    angular
        ...
        .controller('usersManagementController', UsersManegementController);

    function UsersManegementController(
        URLS,
        Translate,
        EnvironmentConfig,
        PAGINATION,
        ...
        vm.url = EnvironmentConfig.site.rest.api
            ...
            + '/' + URLS.management.administration.persona
            + '?' + QUERIES.users.by_existing_email;
